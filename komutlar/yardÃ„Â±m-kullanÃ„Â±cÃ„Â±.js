...
module.exports.run = async(client, message, args) => {
  ...
  let sayfalar = [`
      ...
      > <a:yr_trnctac:797757061353963540> [${prefix}bug-bildir](https://discord.com/oauth2/authorize?client_id=794482280437514241&scope=bot&permissions=8)
      > **• Botta herhangi bir bug olduğunu anladığınız kesinleştirdiğiniz zaman bize iletebilirsiniz.**
      > <a:yr_trnctac:797757061353963540> [${prefix}davet](https://discord.com/oauth2/authorize?client_id=794482280437514241&scope=bot&permissions=8) 
      ...
      > <a:yr_trnctac:797757061353963540> [${prefix}istatistik](https://discord.com/oauth2/authorize?client_id=794482280437514241&scope=bot&permissions=8) 
  ...
  const embed = new Discord.MessageEmbed()
    .setTitle("Replace Bot Kullanıcı Menüsü") 
    .setColor("#ff4400")
   ...
   message.channel.send(embed).then(msg => { 
     ...
     msg.react('797033410484109323').then( r => { 
      ...
      backwards.on('collect', r => { 
        if (page === 1) return; 
        page--; 
        embed.setTitle("Replace Bot Kullanıcı Menüsü")
     ...
     forwards.on('collect', r => { 
        ...
        page++; 
        embed.setTitle("Replace Bot Ayarlanabilir Sistemler")
        embed.setDescription(sayfalar[page-1]); 
        embed.setFooter(`Sayfa ${page} - ${sayfalar.length}`);
