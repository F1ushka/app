...
exports.run = async (bot, message, args) => {  
  ...
  .setTitle('Replace Bot \\\ Buyur Benim İstatistiklerim', bot.user.avatarURL({dynamic: true}))
  ...
  .addField("<a:yr_trnctac:797757061353963540> » **Beni Sunucuna**", " [Eklemeyi Unutma](https://discord.com/oauth2/authorize?client_id=794482280437514241&scope=bot&permissions=8)", true)
  .addField("<a:bildirim:797756868213866498> » **Destek Sunucum**", "[Katılmayı Unutma](https://discord.gg/eGdrw7FnCg)", true)
