...
module.exports.run = async(client, message, args) => {
  ...
  > <a:nice:798438506736910376> [${prefix}öp](https://discord.com/oauth2/authorize?client_id=794482280437514241&scope=bot&permissions=8)
  > **• Birini öpersiniz.**
  ...
  > <a:nice:798438506736910376> [${prefix}kaç-cm](https://discord.com/oauth2/authorize?client_id=794482280437514241&scope=bot&permissions=8)
  ...
  const embed = new Discord.MessageEmbed()
    .setTitle("Replace Bot Eğlence Menüsü") 
    .setColor("#d81414")
    ...
    msg.react('797033410484109323').then( r => { 
     ...
     const forwardsFilter = (reaction, user) => reaction.emoji.name === 'RainbowOkGif' && user.id === message.author.id; 
      ...
      backwards.on('collect', r => { 
        if (page === 1) return; 
        page--; 
        embed.setTitle("Replace Bot Eğlence Menüsü")
